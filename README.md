...
Use smartphone time-series accelerometer and gyroscope data to build a supervised ML classifier that predicts human movement (like sitting, walking, lying down, etc.), transforming raw sensor data into meaningful health insights.
